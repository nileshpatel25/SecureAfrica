        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InternationalPrefix = table.Column<string>(nullable: true),
                    Address = table.Column<string>(nullable: true),
                    CoordinateX = table.Column<float>(nullable: false),
                    CoordinateY = table.Column<float>(nullable: false),
                    AddressLine = table.Column<string>(nullable: true),
                    AdditionalDetails = table.Column<string>(nullable: true),
                    Source = table.Column<string>(nullable: true),
                    PushTokenId = table.Column<string>(nullable: true),
                    OrganizationName = table.Column<string>(nullable: true),
                    EmergencyContactNo = table.Column<string>(nullable: true),
                    IncidentTypeId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmergencyAccountId = table.Column<string>(nullable: true),
                    IncidentTypeId = table.Column<string>(nullable: true),
                    IncidentPic = table.Column<string>(nullable: true),
                    Address = table.Column<string>(nullable: true),
                    AddressLine = table.Column<string>(nullable: true),
                    CoordinateX = table.Column<float>(nullable: false),
                    CoordinateY = table.Column<float>(nullable: false),
